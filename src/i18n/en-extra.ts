...
export const enExtra = {
  settings: {
    ...
    remindersListDesc:
      "The list the sync keeps. Use a list of its own: reminders in it that came from a task " +
      "are updated and deleted as their tasks change. Reminders added by hand are left alone.",
