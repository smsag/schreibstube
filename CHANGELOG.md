...
- **A blank note, and nothing else on screen.** **Focus: new note, sidebars away** makes a new empty note where Obsidian's default location says, named Untitled, Untitled 1 and so on as Obsidian would name it, opens it in a new tab of the main window, collapses both sidebars and puts the cursor in the editor. Three moves became one; the vault sees nothing it would not see from a note made by hand.
